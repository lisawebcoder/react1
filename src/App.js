// I will commnet out default code with search wiki code
/*
...
class App extends React.Component {
  ...
  render() {
    ...
    return (
      <div className="App">
        <center><h1>Wikipedia Search Engine</h1></center>
        <form id="box" action="">
          ...
          <button type='submit' onClick={this.useWikiSearchEngine}><i class ="fa fa-search"></i></button>		  
        </form>
        {wikiSearchResults}
      </div>
    );
